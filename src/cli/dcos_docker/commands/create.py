    ...
    for ports_definition in value:
        ...
        if len(parts) != 2:
            message = (
                ...
                'Please follow this syntax: <HostPort>:<ContainerPort>'
...
@click.option(
    ...
    help=(
        ...
        'The syntax is <HostPort>:<ContainerPort>'
    ),
    multiple=True,
)
